...
# <span style="background-color:black;color:aqua">C</span><span style="background-color:black;color:Blue">o</span><span style="background-color:black;color:blueviolet">l</span><span style="background-color:black;color:chartreuse">o</span><span style="background-color:black;color:crimson">r</span><span style="background-color:black;color:cyan">\_</span><span style="background-color:black;color:darkmagenta">C</span><span style="background-color:black;color:darkorange">o</span><span style="background-color:black;color:deeppink">n</span><span style="background-color:black;color:gold">s</span><span style="background-color:black;color:greenyellow">o</span><span style="background-color:black;color:indigo">l</span><span style="background-color:black;color:lawngreen">e</span><span style="background-color:black;color:violet">  </span><span style="background-color:black;color:lightseagreen">M</span><span style="background-color:black;color:lime">a</span><span style="background-color:black;color:mediumorchid">x</span><span style="background-color:black;color:orange">-</span><span style="background-color:black;color:purple">L</span><span style="background-color:black;color:royalblue">o</span><span style="background-color:black;color:seagreen">a</span><span style="background-color:black;color:tomato">d</span><span style="background-color:black;color:yellow">e</span><span style="background-color:black;color:springgreen">d</span>
___
