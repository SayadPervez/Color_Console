...
setup(
  ...
  description = 'Used to change the text and background color of a python console',   # Give a short description about your library
  author = 'Sayad Pervez.B',                   # Type in your name
  ...
  keywords = ['Command_Line', 'Text', 'Background','Color'],   # Keywords that define your package best
